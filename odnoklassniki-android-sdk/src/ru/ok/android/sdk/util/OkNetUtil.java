...
public class OkNetUtil {
	...
	public static final String performPostRequest(final HttpClient httpClient, final String url, final Map<String, String> params) throws IOException {
	...
	public static final String performGetRequest(final HttpClient httpClient, final String url, final Map<String, String> params) throws IOException {
	...
	private static final String executeHttpRequest(final HttpClient httpClient, final HttpRequestBase httpRequest) throws IOException {
